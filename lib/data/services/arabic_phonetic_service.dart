...
class ArabicPhoneticService {
  ...
  static const Map<String, String> _overrides = {
    ...
    'how are you doing': 'هاو آر يو دوينج',
    'how are you today': 'هاو آر يو توداي',
    'how are you doing today': 'هاو آر يو دوينج توداي',
    'thank you': 'ثانك يو',
    'good morning': 'جود مورنينج',
    'good afternoon': 'جود آفترنون',
    'good evening': 'جود إيفنينج',
    'good night': 'جود نايت',
    ...
    // ---- Everyday vocabulary (natural Egyptian-friendly readings) ----------
    'compare': 'كمبير',
    'comparison': 'كمبيرسن',
    'complete': 'كمليت',
    'continue': 'كونتينيو',
    ...
    'yesterday': 'يستردي',
    'yet': 'يت',
    // irregular readings the engine gets wrong
    'one': 'وان',
    'two': 'تو',
    'won': 'وان',
    'come': 'كَم',
  ...
  String _convertIpa(String raw) {
    ...
    // Never end a word on a bare short-vowel mark: render it as a full
    // letter so the final sound stays readable (…بَ -> …با, not a floating
    // mark that visually disappears and looks truncated).
    out = out.replaceAllMapped(RegExp('[\u064E\u0650\u064F]\$'), (m) {
      switch (m.group(0)) {
        case '\u064E':
          return 'ا';
        case '\u0650':
  ...
  String _normalizeIpa(String raw) {
    ...
    const replacements = {
      'ɡ': 'g', // script g (U+0261)
      'əʊ': 'oʊ', // British GOAT vowel
      'ɜː': 'ɝ', // British NURSE vowel
      'ɒ': 'ɑ', // British LOT vowel
      'ɹ': 'r',
      'ɫ': 'l',
      'ɾ': 'ɾ',
      'ɐ': 'æ',
    ...
    // dictionary brackets/slashes sometimes survive upstream cleanup
